...
func (m *RepositoryManager) repositoryList(cmd *cobra.Command, args []string) error {
	...
	resp, err := apiClient.ListRepositories(m.workspace)
	if err != nil {
		return err
	}
...
func (m *RepositoryManager) repositoryGet(cmd *cobra.Command, args []string) error {
	apiClient := factory.GetClient(m.Cfg)
	resp, err := apiClient.GetRepository(m.workspace, args[0])
	if err != nil {
		return err
	}
	defer resp.Body.Close()
...
func (m *RepositoryManager) repositoryDelete(cmd *cobra.Command, args []string) error {
	apiClient := factory.GetClient(m.Cfg)
	resp, err := apiClient.DeleteRepository(m.workspace, args[0])
	if err != nil {
		return err
	}
	defer resp.Body.Close()
...
func (m *RepositoryManager) repositoryCreate(cmd *cobra.Command, args []string, store string) error {
	...
	resp, err := apiClient.CreateRepository(m.workspace, store, opts)
	if err != nil {
		return err
	}
	defer resp.Body.Close()
...
func (m *RepositoryManager) repositoryDeleteContent(cmd *cobra.Command, args []string) error {
	...
	resp, err := apiClient.DeleteRepositoryContent(m.workspace, name)
	if err != nil {
		return err
	}
	defer resp.Body.Close()
